        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'Water', price: 15, inStock: true },
                        { id: 2, name: 'Apple', price: 10, inStock: true },
                        { id: 3, name: '???', price: 85000, inStock: false }
                    ].map(product => (
            ...
            <section>
                ...
                <select onChange={(e) => alert(`เลือก: ${e.target.value}`)}>
                    ...
                    <option value="js">A</option>
                    <option value="py">B</option>
                    <option value="java">C</option>
                    <option value="go">D</option>
                </select>
            </section>
